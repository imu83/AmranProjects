...
if (sizeof ( $validList ) == sizeof ( $parameterList )) {
	...
	(userID, userPassword, userFullName, userAddress, 
	userCity, userCountry, userCell, userEmail)
	VALUES (
	...
	$resultSet = mysql_query ( $myQuery ) or 
	die ( PrintAsJsonFailedWithMessage ( mysql_error () ) );
